...
### 1. DFS with Global Maximum Tracking
...
- Forgetting that a path doesn't need to pass through root
- Returning the "through" path instead of "extending" path to parent
