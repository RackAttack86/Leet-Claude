...
**Difficulty:** Medium
**Pattern:** Graphs
**Link:** [LeetCode](https://leetcode.com/problems/shortest-path-in-binary-matrix/)
...
- Forgetting to check if start or end is blocked
- Using only 4 directions instead of 8
- Not handling the 1x1 grid edge case
