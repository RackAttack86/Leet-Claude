...
**Difficulty:** Medium
**Pattern:** Graphs
**Link:** [LeetCode](https://leetcode.com/problems/snakes-and-ladders/)
...
### 1. BFS for Shortest Path with Coordinate Conversion
...
- Incorrect Boustrophedon coordinate conversion
- Chaining snakes/ladders (only take one per roll)
- Not handling the visited set correctly
